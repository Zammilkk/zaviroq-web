...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  const service = expandedServices['core-seo'].find((s) => s.slug === 'seo-strategy');
...
export default async function ServicesSeoStrategyPage({ params }: { params: Promise<{ locale: string }> }) {
