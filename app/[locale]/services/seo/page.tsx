export default async function ServicesSeoIndexPage({params}: {params: Promise<{locale: string}>}) {
  ...
  return (
    <div style={{ padding: '120px 20px', minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
      <h1 style={{ fontSize: '3rem', marginBottom: '20px', textAlign: 'center' }}>/services/seo/ Directory</h1>
