...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  const service = expandedServices['core-seo'].find((s) => s.slug === 'keyword-research');
...
export default async function ServicesSeoKeywordResearchPage({ params }: { params: Promise<{ locale: string }> }) {
